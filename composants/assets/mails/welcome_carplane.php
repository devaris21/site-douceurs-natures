...
<!--         <tr>
        ...
        <tr>
            <td align="justify" bgcolor="#ffffff" style="padding: 20px 20px 20px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                <b>Cher(e) <b><u><?= $this->name ?> <?= $this->lastname ?></u></b>, un accès et un espace de connexion vient de vous être dédié sur plateforme web de gestion du parc automobile en tant que bénéficiaire d'un car plan ! Cet espace vous permettra de faire des demandes entretiens pour le vehicule, ou de déclarer d'eventuels sinistres, et bien 'autres !<br><br> Les informations de connexion communiquées ci-dessous vous sont individuelles et vous incomberont de tout acte ou action ménée sur ladite plateforme à partir d'une session ouverte par celles-ci! <br><br> Vous ne devez donc, en aucun cas, les divulguées à une autre personne !</b>
            </td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <tr>
            <td align="center" bgcolor="#f9f9f9" style="padding: 10px 10px 0 10px; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 30px;">
                    <b>Adresse de la plateforme:</b> <a href="http://gpa.artci.lan/carplan">http://gpa.artci.lan/carplan</a>
            </td>
        </tr>
        <tr>
                ...
                <table bgcolor="orangered" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                    <tr>
                        <td align="center" height="50" style=" padding: 0 25px 0 25px; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;" class="button">
                            <a href="http://gpa.artci.lan/carplan" style="color: #ffffff; text-align: center; text-decoration: none;">Aller à mon espace de connexion</a>
                        </td>
                    </tr>
                </table>
            </td>
